...
from ..models import Discussion_Board, Post, Discussion
...
class PostUpdateViewTestCase(TestCase):
    ...
    '''
    def setUp(self):
        self.board = Discussion_Board.objects.create(name='Geriatrics', description='geriatrics discussion.')
        self.username = 'john'
        self.password = '123'
        user = User.objects.create_user(username=self.username, email='john@doe.com', password=self.password)
        self.topic = Discussion.objects.create(subject='Hello, world', board=self.board, started_by=user)
